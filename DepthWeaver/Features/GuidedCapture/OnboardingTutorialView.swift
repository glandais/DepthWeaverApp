...
struct OnboardingTutorialView: View {
        ...
        VStack {
            ZStack {
                ...
                VStack {
                    Spacer()
                    HStack {
                        ForEach(GuidedCaptureModel.Orbit.allCases) { orbit in
    ...
    private func getOrbitImageName(orbit: GuidedCaptureModel.Orbit) -> String? {
    ...
    private let onboardingStateTodetailTextMap: [OnboardingState: String] = [
        .tooFewImages: String(format: LocalizedString.tooFewImagesDetailText, GuidedCaptureModel.minNumImages),
